<template>
  <header class="flex items-center bg-white h-[69px] shadow-md">
    <div class="flex items-center justify-between max-w-[960px] w-full mx-auto">
      <img src="/logo.svg" alt="logo" class="w-[96px]">
